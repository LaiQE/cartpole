...
if __name__ == "__main__":
     ...
     pso.solve()
     bestsolve=pso.parametercd
     print bestsolve #是输出的最优解
     Finalfitness = CartPoleControl.CratpoleControl(bestsolve[0],bestsolve[1],bestsolve[2],bestsolve[3],bestsolve[4],bestsolve[5],bestsolve[6],100,10000,1)
